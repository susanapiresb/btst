...
if (isset($_POST['adicionar'])) {
    ...
    $query = "SELECT codigo FROM public.btstpeca/ddvv0meaeaknjq/ziytsfqigzzvhy@heroku WHERE codigo = '$codigo'";
    ...
    if (pg_affected_rows($resultado) != 0){    //se essa peça ja foi adicionada
        ...
        $query1 = "INSERT INTO public.btstpeca/ddvv0meaeaknjq/ziytsfqigzzvhy@heroku (codigo, nome, imagem, concluida, btsttrabalhador_username, quantidade, prazoentrega) VALUES ('$codigo','$nome','$image',false, '$username', '$quantidade', '$prazoentrega')";
